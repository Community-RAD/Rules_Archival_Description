# 1.4 DATE(S) OF CREATION, INCLUDING PUBLICATION, DISTRIBUTION, ETC., AREA
...
1.  words or phrases indicating the function (other than solely publishing) performed by the person or body
...
2. parts of the name required to differentiate between publishers, distributors, etc., or to identify subsidiary companies.
...
1. when the first and subsequently named entities are linked in a single statement
2. when the first named entity is a distributor, releasing agency, etc., and a publisher is named subsequently
3. when a subsequently named entity is clearly distinguished as the principal publisher, distributor, etc., by layout or typography
4. when the subsequently named publisher, distributor, etc., is in the home country of the institution describing the item and the first named publisher, distributor, etc., is not.
...
Unless:
1. the phrase naming the publisher, distributor, etc., includes words that indicate the function performed by the person(s) or body (bodies) named or
2. the function of the publisher, distributor, etc., agency is clear from the context.
