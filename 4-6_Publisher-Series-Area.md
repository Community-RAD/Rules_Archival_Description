...
## 4.6B. Publisher's series statement

### 4.6B1. 
Transcribe the publisher's series statement as instructed in 1.6.

[^6]: Throughout the rules in this chapter the term publisher's series, as defined in the glossary, is used as a synonym for artist's series, whether the latter be published or unpublished.
