---
layout: single
title: "9.8 RECORDS IN ELECTRONIC FORM, NOTE AREA"
permalink: /9-8/
toc: true
...
>(Computer file requires colour monitor for display)
>
...
>
> Title on paper copy of system documentation: User guide
...
> (Computer files 1 through 4, and 38 on, in this example, belong to different fonds and are entirely unrelated to the unit being described, but are stored on the same magnetic tape for economy of storage.)
>
> The number of records varies with each sub-system (i.e. table) with the largest consisting of 194,264 records or about 12 MB
