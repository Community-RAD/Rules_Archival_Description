...
Specify the location of the formal title proper, if there is more than one formal title in the chief source of information (see 5.1B1). Indicate the
source of a supplied title proper (see 1.8B2).
