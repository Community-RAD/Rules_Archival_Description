---
layout: single
title: "5.7 CARTOGRAPHIC MATERIALS, ARCHIVAL DESCRIPTION AREA"
permalink: /5-7/
toc: true
...
>
> Item is a map showing British Columbia Forest Products Limited's logging roads and campsites in the Nitinat Lake and River area
> (*Scope and content for an item in the* Western Industries Limited fonds)
>
> Item is a fire insurance plan of W.F.I.'s mill at Honeymoon Bay. Insets include a location map and air photograph of the mill, dated Nov. 1959
> (*Scope and content for a 1966 plan in the* Western Forest Industries Limited fonds)
...
[^35]: For further guidance on giving content information for a set of maps, plans, etc. that is incomplete or contains multiple variants of some sheets, see *CM*, 7B18a.
