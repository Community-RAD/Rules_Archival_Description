...
3. for a file, prefer in this order,
    1. sources internal to the file (e.g., title screen, main menu, internal label(s) or other identifying information);
    2. system documentation produced by the agency or person(s) responsible for creating, compiling, editing, or producing the records in electronic form in the file;
    3. other sources (including information on the physical carrier or its container, issued by the creator, publisher, distributor, etc.). Prefer any permanently affixed paper, plastic, etc., label that is added by the publisher, distributor, etc. of the file, as opposed to those added locally, and as opposed to the container itself, which may have data embossed or printed on it.
4. For an item, prefer in this order,
    1. sources internal to the item (e.g., title screen, main menu, internal label(s) or other identifying information);
    2. system documentation produced by the agency or person(s) responsible for creating, compiling, editing, or producing the records in electronic form in the item;
