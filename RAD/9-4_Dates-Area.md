...
### 9.4A3. 
In presenting information in the dates of creation, including distribution,
publication, etc., area, follow the instructions set out in 1.4A3-1.4A7.

## 9.4B. Date(s) of creation

### 9.4B1. 
At all levels of description, give the dates of creation for the unit being described as instructed in 1.4B.

> 1988-1994
>
> [Digitized 1980]
>
> Digitized 1992-1993 (originally created 1965-1990)

## 9.4C. Place of publication, distribution, etc.
...
### 9.4D1. 
Give the name of the publisher, distributor, etc., of the unit being described as instructed in 1.4D. Give information about person(s) or institution(s) responsible for the scanning, inputting, digitizing, or funding in a note (see 9.8B9).
...
> Ottawa, Ont. : Statistics Canada [producer] ; Toronto, Ont. : Data Library Service, University of Toronto [distributor]
