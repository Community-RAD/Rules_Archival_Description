...
To comment on this site you will need a GitHub account. To create an account, all you need is an email, username, and password. You can create an account [here](https://github.com/signup) or follow [this tutorial](https://docs.github.com/en/get-started/start-your-journey/creating-an-account-on-github) for additional instructions.
...
### [Site Recommendations](recommendations.md)
